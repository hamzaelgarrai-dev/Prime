...
export default function HeroButtomCard() {
    ...
    return (
        ...
        <div className="bg-[#042433] w-[1080px] h-[325px] mx-auto -mt-58 flex flex-col justify-between items-center md:flex-row relative"  >
            ...
            <div className="text-[#CBCBCB] mr-8 p-15 max-w-[520px]">
                ...
                <div className="pt-7">
                    ...
                    className="bg-[#ffffff] text-[#002639] w-48  text-xs px-6 py-3  rounded-full flex items-center gap-1 font-bold transition-all group
                  hover:bg-[#3da5d9] hover:text-white"
                >
                    Découvrez pprimer
                    <div
                        className="bg-[#002639] border border-white w-6 h-6 rounded-2xl   flex items-center justify-center transition-all
